...
#ifndef _CRANE1_FOLLOW_MACHINE_H_
#define _CRANE1_FOLLOW_MACHINE_H_

#include <funcbloc.h>
#include <forte_bool.h>
#include <forte_int.h>

class FORTE_CRANE1_FOLLOW_MACHINE: public CFunctionBlock{
  DECLARE_FIRMWARE_FB(FORTE_CRANE1_FOLLOW_MACHINE)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_CRANE1_FOLLOW_MACHINE){
  };

  virtual ~FORTE_CRANE1_FOLLOW_MACHINE(){};
