...
#ifndef _CRANE1_DECIDER_H_
#define _CRANE1_DECIDER_H_

#include <funcbloc.h>
#include <forte_bool.h>
#include <forte_int.h>

class FORTE_CRANE1_DECIDER: public CFunctionBlock{
  DECLARE_FIRMWARE_FB(FORTE_CRANE1_DECIDER)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_CRANE1_DECIDER){
  };

  virtual ~FORTE_CRANE1_DECIDER(){};
