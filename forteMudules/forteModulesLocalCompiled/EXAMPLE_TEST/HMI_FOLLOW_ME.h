...
#ifndef _HMI_FOLLOW_ME_H_
#define _HMI_FOLLOW_ME_H_

#include <funcbloc.h>
#include <forte_bool.h>
#include <forte_int.h>

class FORTE_HMI_FOLLOW_ME: public CFunctionBlock{
  DECLARE_FIRMWARE_FB(FORTE_HMI_FOLLOW_ME)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_HMI_FOLLOW_ME){
  };

  virtual ~FORTE_HMI_FOLLOW_ME(){};
